...
font = ('times', 16, 'bold')
title = Label(main, text='                           Congregating Traffic Information Using Canny Edge Detection Algorithm',anchor=W, justify=CENTER)
